<template>
  ...
  >
    ...
    <div class="overflow-x-auto">
      ...
      >
        <div class="ml-14 w-full lg:w-4/6">
          ...
          <div class="bg-white shadow-md rounded my-6">
            <h2 class="text-left mb-4 text-xl font-bold text-gray-700">
              Resident's Record
            </h2>
            <table class="min-w-max w-full table-auto">
              <thead>
                ...
                >
                  ...
                  <th class="py-3 px-6 text-center">Civil Status</th>
                  <th class="py-3 px-6 text-center">Gender</th>
                  <th class="py-3 px-6 text-center">Voter Status</th>
              ...
              <tbody class="text-gray-600 text-sm font-light">
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                  ...
                  <td class="py-3 px-6 text-left">
                    <div class="flex items-center">
                      <span>Cherry Mae C. Cabanes</span>
                    </div>
                  </td>
            ...
            <div>
              <ul class="flex pl-0 list-none rounded my-2 mr-1.5 justify-end">
                <li
